...
<em>NOTE:</em> This application also runs on both a GPU and a CPU (note the training parameters are set for GPU training, please scale down the Model Constants in model.py for faster training<br/><br/>
